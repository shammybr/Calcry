...
class Window():
    ...
    def __init__(self, width, height):
        ...
        Window.screen = pygame.display.set_mode([self.width, self.height], pygame.RESIZABLE)
...
#------------------------DRAW METHODS-------------------------------
 ...
 #   def draw_text(self, text, x, y, size=12, color=(0,0,0),
  #               font_name="Arial", bold=False, italic=False):
        #fonte da pasta
    def draw_text(self, text, x, y, font_local, size=12, color=(0,0,0), bold=False, italic=False):

        # Creates a Font from the system fonts
        # SysFont(name, size, bold=False, italic=False) -> Font
        font = pygame.font.Font(font_local, size)
